 ...
 */
class Version20150727134926 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE speakers (id INT AUTO_INCREMENT NOT NULL, deletedAt DATETIME DEFAULT NULL, name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, gender VARCHAR(6) NOT NULL, url VARCHAR(255) DEFAULT NULL, facebook_url VARCHAR(255) DEFAULT NULL, bio LONGTEXT DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, phone_number VARCHAR(35) DEFAULT NULL COMMENT \'(DC2Type:phone_number)\', email VARCHAR(255) DEFAULT NULL, createdAt DATETIME NOT NULL, updatedAt DATETIME NOT NULL, createdBy VARCHAR(255) DEFAULT NULL, updatedBy VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE meetings ADD CONSTRAINT FK_44FE52E2DA6A219 FOREIGN KEY (place_id) REFERENCES places (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE meetings DROP FOREIGN KEY FK_44FE52E2DA6A219');
