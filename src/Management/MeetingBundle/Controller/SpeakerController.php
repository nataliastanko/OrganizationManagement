...
namespace Management\MeetingBundle\Controller;
...
use Management\MeetingBundle\Entity\Speaker;
use Management\MeetingBundle\Form\SpeakerType;
...
class SpeakerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ManagementMeetingBundle:Speaker')->findAll();
     ...
     * @Method("POST")
     * @Template("ManagementMeetingBundle:Speaker:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ManagementMeetingBundle:Speaker')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ManagementMeetingBundle:Speaker:edit.html.twig")
     */
