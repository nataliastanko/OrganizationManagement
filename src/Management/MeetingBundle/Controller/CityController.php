...
use Management\MeetingBundle\Entity\City;
use Management\MeetingBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ManagementMeetingBundle:City')->findAll();
     ...
     * @Method("POST")
     * @Template("ManagementMeetingBundle:City:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ManagementMeetingBundle:City')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ManagementMeetingBundle:City:edit.html.twig")
     */
