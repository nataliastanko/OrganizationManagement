...
use Management\MeetingBundle\Entity\Topic;
use Management\MeetingBundle\Form\TopicType;
...
class TopicController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ManagementMeetingBundle:Topic')->findAll();
     ...
     * @Method("POST")
     * @Template("ManagementMeetingBundle:Topic:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ManagementMeetingBundle:Topic')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ManagementMeetingBundle:Topic:edit.html.twig")
     */
