...
use Organization\MeetingBundle\Entity\Topic;
use Organization\MeetingBundle\Form\TopicType;
...
class TopicController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrganizationMeetingBundle:Topic')->findAll();
     ...
     * @Method("POST")
     * @Template("OrganizationMeetingBundle:Topic:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrganizationMeetingBundle:Topic')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrganizationMeetingBundle:Topic:edit.html.twig")
     */
