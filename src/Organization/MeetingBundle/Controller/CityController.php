...
use Organization\MeetingBundle\Entity\City;
use Organization\MeetingBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrganizationMeetingBundle:City')->findAll();
     ...
     * @Method("POST")
     * @Template("OrganizationMeetingBundle:City:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrganizationMeetingBundle:City')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrganizationMeetingBundle:City:edit.html.twig")
     */
