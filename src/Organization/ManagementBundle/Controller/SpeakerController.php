...
use Organization\ManagementBundle\Form\SpeakerType;
...
class SpeakerController extends Controller
{
     ...
     * @Method("POST")
     * @Template("OrganizationManagementBundle:Speaker:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrganizationManagementBundle:Speaker')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrganizationManagementBundle:Speaker:edit.html.twig")
     */
