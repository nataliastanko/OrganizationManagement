...
use Organization\ManagementBundle\Entity\Topic;
use Organization\ManagementBundle\Form\TopicType;
...
class TopicController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrganizationManagementBundle:Topic')->findAll();
     ...
     * @Method("POST")
     * @Template("OrganizationManagementBundle:Topic:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('OrganizationManagementBundle:Topic')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrganizationManagementBundle:Topic:edit.html.twig")
     */
