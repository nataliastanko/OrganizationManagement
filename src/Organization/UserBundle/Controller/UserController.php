...
namespace Organization\UserBundle\Controller;
...
use Organization\UserBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('OrganizationUserBundle:User')->findAll();
    ...
    */
     ...
     * @Method("PUT")
     * @Template("OrganizationUserBundle:User:edit.html.twig")
     */
